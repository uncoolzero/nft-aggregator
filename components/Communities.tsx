...
return(
    <div className="bg-slate-800 w-full text-3xl flex flex-col rounded-lg md:flex-row md:content-center">
        ...
        {data.map((data) =>
            <div className="min-w-full md:min-w-[47%] lg:min-w-[32%] bg-cover bg-center rounded-lg overflow-clip" style={{backgroundImage: `url(${data.image})`}}>
                <div className="w-full h-full md:w-[101%] md:h-[101%] overflow-clip backdrop-blur-3xl backdrop-brightness-50">
