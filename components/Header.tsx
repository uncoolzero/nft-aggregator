...
return (
  ...
  <div className="flex flex-col">
    <header className="bg-[#0d1525]/90 backdrop-blur-xl z-20 w-full px-6 py-4 font-bold text-lg gap-x-3 flex flex-row md:py-6 xl:py-4">
    ...
    <div id="menu"className="menu-off">
        <div className="text-3xl h-[90%] grid grid-rows-[repeat(8,_minmax(0,_1fr))]">
          ...
          <div className="menu-rows hover:bg-transparent">
            ...
            <div onClick={toggleNightMode} className="bg-white rounded-full h-8 w-[4.5rem] place-self-center">
              <div className="night-mode-on" />
            </div>
